                ...
                {!selectedEventType.hasBookings ? (
                  <>
                    <button
                      ...
                      onClick={() =>
                        setPendingAction((currentAction) =>
                          currentAction === "delete" ? null : "delete",
                        )
                      }
                    >
                      Удалить
                    ...
                    {pendingAction === "delete" ? (
                      <div className="owner-confirmation">
                        <p>
                          Удалить тип события? Он исчезнет из owner workspace и будущих вариантов
                          записи.
                        </p>
                        <div className="owner-confirmation__actions">
                          <button
                            type="button"
                            className="danger-button"
                  ...
                  <>
                    <button
                      ...
                      onClick={() =>
                        setPendingAction((currentAction) =>
                          currentAction === "archive" ? null : "archive",
                        )
                      }
                    >
                      Архивировать
                    ...
                    {pendingAction === "archive" ? (
                      <div className="owner-confirmation">
                        <p>
                          Перевести тип в архив? Он останется видимым в owner списке для истории
                          бронирований.
                        </p>
                        <div className="owner-confirmation__actions">
                          <button
                  ...
                  <p className="empty-copy">Архивный тип остается в списке и недоступен для удаления.</p>
                )}
              </div>
            ) : null}
          </div>
